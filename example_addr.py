...
def main():
    ...
    vault_address = "0x19ee977043c0ddc263d30ef7054272cead8dd763"
    address, info, exchange = example_utils.setup(vault_address=vault_address, base_url=constants.MAINNET_API_URL, )
